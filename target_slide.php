...
<!-- Mirrored from www.Target Career Institute.edu.in/slider.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Feb 2016 09:51:58 GMT -->
<head> 
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0"> 
    <title>Introduction Slider Demo - Jssor Slider, Carousel, Slideshow with Javascript Source Code</title>
</head> 
<body style="margin:0;padding:0; background:#fff; font-family: Arial, Verdana, Sans-Serif;"> 
    ...
    <div id="slider1_container" style="position: relative; width: 1000px; height: 380px; overflow: hidden;">
        ...
        <!-- Slides Container --> 
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width:1000px; height: 380px;
            overflow: hidden;">
        ...
        <!-- Arrow Left -->
        <span u="arrowleft" class="jssora20l" style="top: 123px; left: 8px;"> left
        </span>
        <!-- Arrow Right -->
        <span u="arrowright" class="jssora20r" style="top: 123px; right: 8px;"> Right
        </span>
