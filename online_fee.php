 ...
 <div class="row">
  ...
  <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
     ...
     <div class="R2 table-bordered">
		...
		<p>
		<b>Sorry!!! Online Fee Facility Not Avaliable Due To Some Problems.</b>  <br />
		Please Contact Us To Know About Fee Payment Method.
		 <a href="contact_us.php" style="font-size:20px"> Contact</a>
		<hr />
